class Solution {
   ...
   findNumberOfLIS(nums) {
      ...
      const cache = Array.from({ length: nums.length }, () => [1, 1]);
      let lisLen = 1;

      for (let left = nums.length - 1; left > -1; left--) {
         let lisLen = cache[left][0];
