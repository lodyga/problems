   ...
   robotSim(commands, obstacles) {
      ...
      for (const command of commands) {
         if (command === -1) {
            ...
            for (let _ = 0; _ < command; _++) {
               if (obstacleSet.has(`${x + dx},${y + dy}`)) {
                  break
               } else {
                  x += dx;
                  y += dy;
