...
class Solution:
    def findAllPeople(self, n: int, meetings: list[list[int]], firstPerson: int) -> list[int]:
        ...
        while index < M:
            curr_people = set()
            time_stamp = meetings[index][2]
            
            while (index < M and time_stamp == meetings[index][2]):
                u, v, _ = meetings[index]
                dsu.union(u, v)
                curr_people.add(u)
                curr_people.add(v)
                index += 1
