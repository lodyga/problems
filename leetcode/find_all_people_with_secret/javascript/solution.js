...
class Solution {
   ...
   findAllPeople(n, meetings, firstPerson) {
      ...
      while (index < M) {
         ...
         const timeStamp = meetings[index][2];

         while (index < M && timeStamp == meetings[index][2]) {
            const [u, v,] = meetings[index];
            dsu.union(u, v);
            currPeople.add(u);
            currPeople.add(v);
            index++;
      ...
      for (let person = 0; person < n; person++) {
         if (dsu.parent[person] === dsu.parent[0]) {
            res.push(person);/*  */
         }
      }
