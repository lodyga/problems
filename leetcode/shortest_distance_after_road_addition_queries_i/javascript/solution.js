...
class Solution {
   ...
   shortestDistanceAfterQueries(n, queries) {
      const nexts = Array.from({ length: n - 1 }, (_, index) => [index + 1])
      const res = []
      ...
      const bfs = () => {
         ...
         while (queue.size()) {
            ...
            for (const nextCity of nexts[city]) {
